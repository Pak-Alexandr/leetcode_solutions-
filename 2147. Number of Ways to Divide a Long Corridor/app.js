...
console.log(numberOfWays('PPSPSP'))
console.log(numberOfWays('S'))
console.log(numberOfWays("SPPSSSSPPS"))
console.log(numberOfWays("P"))
console.log(numberOfWays("SPSPPSSPSSSS"))
console.log(numberOfWays("SPPSSSSPPS"))
console.log(numberOfWays("PPPPPSPPSPPSPPPSPPPPSPPPPSPPPPSPPSPPPSPSPPPSPSPPPSPSPPPSPSPPPPSPPPPSPPPSPPSPPPPSPSPPPPSPSPPPPSPSPPPSPPSPPPPSPSPSS"))